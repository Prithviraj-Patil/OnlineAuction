...
class MyParser {
	...
	public static String CreateDataRow(String... DataColumns) {

		String DataRow = "";
		if (DataColumns.length > 0) {
			DataRow = DataRow + DataColumns[0];
			for (int dataIterator = 1; dataIterator < DataColumns.length; dataIterator++) {
				DataRow = DataRow + columnSeparator + DataColumns[dataIterator];
			}
		}
		return DataRow;
	}
	...
	public static void main(String[] args) throws IOException {
		...
		File ItemFile = new File("TmpAuctionItems.dat");
		if (ItemFile.exists()) {
			ItemFile.delete();
		}
		...
		File CategoryFile = new File("TmpAuctionItemCategories.dat");
		...
		File SellerFile = new File("TmpSellers.dat");
		...
		File BidderFile = new File("TmpBidders.dat");
		...
		File BidFile = new File("TmpBids.dat");
		if (BidFile.exists()) {
			BidFile.delete();
		}
