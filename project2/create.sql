...
-- Tables created: AuctionItem, AutionItemCategory, AuctionUser, Bid --
...
-- Primary Key: CategoryKey --
	...
	CREATE TABLE IF NOT EXISTS AutionItemCategory(
...
-- Creates AuctionUser table to store all user information--
-- Primary Key: UserID --
